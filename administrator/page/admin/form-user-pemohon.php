  ...
  <div class="col-md-8">
    ...
    <div class="padding-30 sm-padding-5">
      <form class="m-t-25 m-b-20">
        ...
        <div class="row m-t-5">
          <div class="col-md-4">
            <div class="form-group form-group-default form-group-default-select2">
              ...
              <select data-init-plugin='select2' id="jantina" name="jantina" class="form-control full-width" >
                <?php getJantina(); ?>
              </select>
          ...
          <div class="col-md-4">
            <div class="form-group form-group-default form-group-default-select2">
              ...
              <select data-init-plugin='select2' id="nationality" name="nationality" class="form-control full-width" >
                <?php getNegara(); ?>
              </select>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group form-group-default form-group-default-select2">
              ...
              <select data-init-plugin='select2' id="bangsa" name="bangsa" class="form-control full-width" >
                <?php getKeturunan(); ?>
              </select>
            </div>
          </div>
        ...
        <h5 class="text-black block-title">Alamat Surat Menyurat</h5>
        ...
        <div class="row m-t-5">
          ...
          <div class="col-md-4">
            <div class="form-group form-group-default form-group-default-select2">
              ...
              <select data-init-plugin='select2' id="negeri" name="negeri" class="form-control full-width" >
                <?php getNegeri(); ?>
              </select>
            </div>
          </div>
        ...
        <h5 class="text-black block-title">Maklumat Telekomunikasi</h5>
        ...
        <h5 class="text-black block-title">Maklumat Media Sosial</h5>
        ...
        <div class="row m-t-20">
          <div class="col-md-12">
            ...
            <button type="button" class="btn btn-primary" name="button">Kemaskini <i class="fa fa-edit m-l-5"></i> </button>
          </div>
        </div>
      </form>
    </div>
