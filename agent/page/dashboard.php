...
<div class="content sm-gutter">
  <div class="container  no-padding">
        ...
        <div class="widget-11-2 card no-border card-condensed no-margin widget-loader-circle d-flex flex-column align-self-stretch">
          ...
          <div class="padding-25">
            <div class="pull-left">
              ...
              <p class="no-margin">Cakes Pending Delivery</p>
            </div>
            <div class="clearfix"></div>
          </div>
          <div class="auto-overflow widget-11-2-tablea">
        ...
        <div class="widget-11-2 card no-border card-condensed no-margin widget-loader-circle d-flex flex-column align-self-stretch">
          ...
          <div class="padding-25">
            <div class="pull-left">
              ...
              <p class="no-margin">Latest dropship agent sales transaction</p>
            </div>
            <!-- <h3 class="pull-right semi-bold"><sup>
              <small class="semi-bold m-r-10">RM </small>
            </sup> <span id="salesValue">00.00</span>
    ...
    <div class="col-lg-3 sm-m-t-10 d-flex align-items-stretch">
      <div class="widget-11-2 card no-border card-condensed no-margin widget-loader-circle d-flex flex-column align-self-stretc">
        <div class="card-header top-right">
          <div class="card-controls">
            <ul>
              <li><a data-toggle="refresh" class="portlet-refresh text-black" href="#"><i class="portlet-icon portlet-icon-refresh"></i></a>
        ...
        <div class="padding-25">
          <div class="row">
            <div class="col-12">
              <div class="pull-left">
                <h2 class="text-success no-margin font-montserrat text-uppercase">Telegram</h2>
                <p class="no-margin">Marketing Material</p>
              </div>
            </div>
          </div>
